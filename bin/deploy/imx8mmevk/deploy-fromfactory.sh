...
cp -L $FOLDER/imx-boot-imx8mmevk .
cp -L $FOLDER/u-boot-imx8mmevk.itb .
cp -L $FOLDER/lmp-factory-image-imx8mmevk.wic.gz .
gunzip lmp-factory-image-imx8mmevk.wic.gz
cp -L $FOLDER/sit-imx8mmevk.bin .
